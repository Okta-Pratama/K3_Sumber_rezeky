...
jquery__WEBPACK_IMPORTED_MODULE_1__(document).ready(function () {
  ...
  var navbarDD = document.getElementsByClassName("drop-down-navbar");
  ...
  for (var i = 0; i < navbarLinks.length; i++) {
    ...
    if (navbarLinks[i].getAttribute("href") === currentPage) {
      ...
      if (["landasanHukum.html", "lingkunganKerjaFisik.html", "apd.html", "kesehatanKerja.html", "keselamatanKerja.html", "PP.html"].includes(currentPage)) {
        for (var j = 0; j < navbarDD.length; j++) {
          navbarDD[j].classList.add("navbar-link-active");
        }
      }
